"""
    SingularityHA Environment Module
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
""" Pull in lights and write to file """
...
for object in r['objects']:
    ...
    sensors[object['name']] = attrib

target = open(os.path.dirname(os.path.realpath(__file__)) + "/sensors.json", 'w')
target.write(json.dumps(sensors))
target.close
